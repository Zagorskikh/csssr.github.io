...
Хм, теперь кажется, что функция ни от чего не зависит и вообще ничего не делает. В целом все логично — не видя реализации функции, мы не можем что-то сказать о том, что она делает. Давайте посмотрим на другую функцию:
...
На самом деле, скорее всего, последнии два свойства вытекают из первого свойства — но это только догадка, и поэтому я решил оставить это отдельным пунктом.
